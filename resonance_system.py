...
RESONANCE_PACTS = [
    # ========== 狂暴侵蚀 ==========
    ResonancePact(ResonanceType.FURY, ResonanceLevel.MINOR, "轻度狂暴", "敌人伤害 +20%", 1, {"enemy_damage_mult": 1.2}),
    ResonancePact(
        ResonanceType.FURY, ResonanceLevel.MODERATE, "中度狂暴", "敌人伤害 +40%", 2, {"enemy_damage_mult": 1.4}
    ),
    ResonancePact(
        ResonanceType.FURY,
        ResonanceLevel.EXTREME,
        "极度狂暴",
        "敌人伤害 +60%，暴击率 +15%",
        3,
    ...
    # ========== 坚韧侵蚀 ==========
    ResonancePact(
        ResonanceType.TENACITY, ResonanceLevel.MINOR, "轻度坚韧", "敌人生命 +30%", 1, {"enemy_health_mult": 1.3}
    ),
    ResonancePact(
        ResonanceType.TENACITY, ResonanceLevel.MODERATE, "中度坚韧", "敌人生命 +60%", 2, {"enemy_health_mult": 1.6}
    ),
    ResonancePact(
        ResonanceType.TENACITY,
        ResonanceLevel.EXTREME,
        "极度坚韧",
        "敌人生命 +100%，减伤 +20%",
        3,
    ...
    # ========== 迅捷侵蚀 ==========
    ResonancePact(
        ResonanceType.SWIFT, ResonanceLevel.MINOR, "轻度迅捷", "敌人速度 +15%", 1, {"enemy_speed_mult": 1.15}
    ),
    ResonancePact(
        ResonanceType.SWIFT, ResonanceLevel.MODERATE, "中度迅捷", "敌人速度 +30%", 2, {"enemy_speed_mult": 1.3}
    ),
    ResonancePact(
        ResonanceType.SWIFT,
        ResonanceLevel.EXTREME,
    ...
    # ========== 增殖侵蚀 ==========
    ResonancePact(ResonanceType.SWARM, ResonanceLevel.MINOR, "轻度增殖", "敌人数量 +1", 1, {"enemy_count_add": 1}),
    ResonancePact(
        ResonanceType.SWARM,
    ...
    # ========== 混沌侵蚀 ==========
    ResonancePact(
        ResonanceType.CHAOS, ResonanceLevel.MINOR, "轻度混沌", "敌人随机元素", 1, {"enemy_random_element": True}
    ),
    ResonancePact(
        ResonanceType.CHAOS, ResonanceLevel.MODERATE, "中度混沌", "Boss 额外技能", 2, {"boss_extra_skill": True}
    ),
    ResonancePact(
        ResonanceType.CHAOS, ResonanceLevel.EXTREME, "极度混沌", "所有敌人精英化", 3, {"all_enemies_elite": True}
    ),
    # ========== 贫瘠侵蚀 ==========
    ResonancePact(ResonanceType.BARREN, ResonanceLevel.MINOR, "轻度贫瘠", "灵石掉落 -20%", 1, {"lingshi_mult": 0.8}),
    ResonancePact(
        ResonanceType.BARREN, ResonanceLevel.MODERATE, "中度贫瘠", "商店价格 +30%", 2, {"shop_price_mult": 1.3}
    ),
    ResonancePact(
        ResonanceType.BARREN,
        ResonanceLevel.EXTREME,
        "极度贫瘠",
        "开局饰品 -1，丹药 -1",
        3,
