...
def create_kill_particles(x, y, enemy_color):
    ...
    for _ in range(12):
        ...
        particles.append(Particle(x, y, vx, vy, color=color, lifetime=0.6, size=random.randint(4, 7), shrink=True))
    ...
    for _ in range(8):
        ...
        particles.append(
            Particle(x, y, vx, vy, color=(255, 255, 200), lifetime=0.3, size=random.randint(2, 4), shrink=True)
        )
...
def create_elite_kill_particles(x, y, enemy_color):
    ...
    for _ in range(20):
        ...
        particles.append(Particle(x, y, vx, vy, color=color, lifetime=0.8, size=random.randint(6, 10), shrink=True))
    ...
    for _ in range(12):
        ...
        particles.append(
            Particle(x, y, vx, vy, color=(255, 215, 0), lifetime=1.0, size=random.randint(5, 8), shrink=True)
        )
...
def create_levelup_particles(x, y):
    ...
    for i in range(16):
        ...
        particles.append(Particle(px, py, vx, vy, color=(255, 255, 100), lifetime=1.2, size=6, shrink=True))
    ...
    for _ in range(8):
        ...
        particles.append(Particle(x, y, vx, vy, color=(255, 215, 0), lifetime=0.8, size=8, shrink=True))
...
def create_item_get_particles(x, y, item_type="common"):
    ...
    for i in range(12):
        ...
        particles.append(Particle(px, py, vx, vy, color=color, lifetime=1.0, size=5, shrink=True))
    ...
    for _ in range(6):
        ...
        particles.append(Particle(x, y, vx, vy, color=(255, 255, 255), lifetime=0.5, size=4, shrink=True))
...
def create_heal_particles(x, y):
    ...
    for _ in range(4):
        ...
        particles.append(Particle(x, y, vx, vy, color=(200, 255, 200), lifetime=0.4, size=6, shrink=True))
...
def create_crit_particles(x, y):
    ...
    for _ in range(8):
        ...
        particles.append(Particle(x, y, vx, vy, color=(255, 255, 100), lifetime=0.5, size=6, shrink=True))
    ...
    for _ in range(4):
        ...
        particles.append(Particle(x, y, vx, vy, color=(255, 215, 0), lifetime=0.6, size=8, shrink=True))
...
def create_skill_cast_particles(x, y, element_color):
    ...
    for i in range(12):
        ...
        particles.append(Particle(x, y, vx, vy, color=element_color, lifetime=0.6, size=5, shrink=True))
    ...
    for _ in range(6):
        ...
        particles.append(Particle(x, y, vx, vy, color=(255, 255, 255), lifetime=0.4, size=7, shrink=True))
