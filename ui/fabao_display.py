...
class FabaoDisplay(UIComponent):
    ...
    def _draw_impl(self, screen):
        ...
        draw_text(screen, fabao.name[:4], self.x + 8, name_y,
                 FontSize.XS, Colors.TEXT_LIGHT, center=False)
    ...
    def _draw_tooltip(self, screen, fabao):
        ...
        # 法宝名称
        draw_text(screen, fabao.name, tooltip_x + Spacing.SM, tooltip_y + Spacing.SM,
                 FontSize.BASE, Colors.TEXT_GOLD)
        ...
        draw_text(screen, attr_text, tooltip_x + Spacing.SM, tooltip_y + Spacing.SM + 22,
        ...
        draw_text(screen, f"形态: {form_text}", tooltip_x + Spacing.SM, tooltip_y + Spacing.SM + 44,
                 FontSize.SM, Colors.TEXT_LIGHT)
        
        # 伤害和攻速
        draw_text(screen, f"伤害: {fabao.damage}", tooltip_x + Spacing.SM, tooltip_y + Spacing.SM + 66,
                 FontSize.SM, Colors.TEXT_LIGHT)
        
        cd_text = f"{fabao.attack_cooldown:.2f}s"
        draw_text(screen, f"攻速: {cd_text}", tooltip_x + Spacing.SM, tooltip_y + Spacing.SM + 88,
                 FontSize.SM, Colors.TEXT_LIGHT)
...
class DualFabaoDisplay(UIComponent):
    ...
    def _draw_impl(self, screen):
        ...
        # 绘制切换提示
        hint_y = self.y + 85
        draw_text(screen, "[Tab] 切换法宝", self.x, hint_y,
