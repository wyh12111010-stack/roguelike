...
def get_partner(id: str) -> PartnerConfig | None:
...
# 特殊对话：共鸣强度 10 时触发
RESONANCE_DIALOGUES = {
    "xuanxiao": {10: "共鸣强度 10...你已经触及了雷法的本质。秽源虽强，但你的意志更强。这是我的雷诀，送给你。"},
    "qingli": {10: "你已经掌握了风之道的真谛。在如此强烈的秽源侵蚀下，你依然保持着清明。这份定力，令人钦佩。"},
    "chiyuan": {10: "共鸣强度 10...你已经触及了剑道的本质。这是我当年面对秽源时的境界。这是我的剑诀，送给你。"},
    "biluo": {10: "你已经掌握了丹道的真谛。在如此强烈的秽源侵蚀下炼丹，需要极高的控制力。这是我的丹方，送给你。"},
    "moyu": {10: "共鸣强度 10...你已经触及了影之道的极限。秽源的侵蚀反而让你的影术更加纯粹。这是我的影诀，送给你。"},
    "chixia": {10: "共鸣强度 10...你已经触及了世界意识的本质。秽源虽强，但你的意志更强。继续前进吧，少年。"},
}
