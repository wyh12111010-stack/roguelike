...
class IconGenerator:
    ...
    def check_api(self):
        ...
        try:
            ...
            print(f"[ERROR] 无法连接到 SD WebUI：{str(e)}")
...
def main():
    ...
    parser.add_argument('--category', type=str, choices=['fabao', 'accessory', 'linggen', 'all'],
                       default='fabao', help='图标类别')
