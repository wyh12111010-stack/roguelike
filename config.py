...
ENEMY_MAX_SPEED = 175  # 敌人移速上限，保证主角（含 debuff）仍可拉开距离
...
COLOR_ARENA = (60, 60, 80)      # 框内背景
COLOR_ARENA_BORDER = (100, 100, 120)  # 框边界
COLOR_ENTRANCE = (80, 120, 160)       # 入口
COLOR_ENTRANCE_HOVER = (120, 180, 220)  # 入口悬停

# 血条蓝条（角色脚下小条）
COLOR_HP_BAR = (220, 60, 60)
COLOR_HP_BG = (60, 30, 30)
COLOR_MP_BAR = (60, 120, 220)
COLOR_MP_BG = (30, 50, 80)
