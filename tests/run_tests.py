...
def test_ui(screen):
    ...
    from ui.components import ProgressBar, Panel, Colors
    from player import Player
    from config import ARENA_X, ARENA_Y, ARENA_W, ARENA_H
