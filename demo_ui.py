...
from ui_theme import (
    ...
    draw_resource, draw_progress_bar, draw_glow, ImmortalParticle
)
...
while running:
    ...
    draw_progress_bar(screen, hp_rect, demo_data["health"], demo_data["max_health"], 
                     THEME_COLORS["health"], show_text=True)
    ...
    draw_progress_bar(screen, mp_rect, demo_data["mana"], demo_data["max_mana"],
                     THEME_COLORS["mana"], show_text=True)
