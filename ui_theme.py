...
class AnimatedBackground:
    ...
    def draw(self, surface):
        # 深邃夜空渐变
        gradient = create_gradient_surface(self.width, self.height, THEME_COLORS["bg_deep"], THEME_COLORS["bg_mid"])
...
def draw_panel(surface, rect, title=None, glow=True):
    ...
    if title:
        ...
        pygame.draw.line(surface, THEME_COLORS["panel_border"], (rect.left + 20, line_y), (rect.right - 20, line_y), 1)
